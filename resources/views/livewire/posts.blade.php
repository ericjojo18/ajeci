<div class="container mx-auto mt-10 ">
    <x-jet-banner />
        <div class="flex content-center m-2 p-6">
            <x-jet-button wire:click="showCreatePostModal" class="bg-green-500"> Créer un article</x-jet-button>
        </div>
      ...
      <table class="min-w-full divide-y divide-gray-200">
        <thead class="bg-gray-50 dark:bg-gray-600 dark:text-gray-200">
          <tr>
            ...
            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-200 uppercase tracking-wider">Date de création</th>
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          ...
          <tr>
            ...
            <td class="px-6 py-4 whitespace-nowrap">{{ $post->titre }}</td>
